...
![](imgs/hex-gganimate.png){fig-align="center" width="45%"}
...
* [`marquee`](https://marquee.r-lib.org/) - add rendered markdown to your plots

* [`thematic`](https://rstudio.github.io/thematic/) & [`brand.yml`](https://posit-dev.github.io/brand-yml/) - automatic theming of plots to match your app / site

* [`ggridges`](https://cran.r-project.org/web/packages/ggridges/vignettes/introduction.html) - creates ridgeline plots (stacked density plots)

* [`ggdist`](https://mjskay.github.io/ggdist/) - visualizations and utilities for distributions and uncertainty (think bayesian model output)

* [`legendry`](https://teunbrand.github.io/legendry/) - adds additional guides (legends) to ggplot2
...
<iframe data-src="https://exts.ggplot2.tidyverse.org/gallery/" width="100%" height="500px" style="border:1px solid;border-radius: 5px;" data-external="1">
</iframe>
...
<iframe data-src="https://www.gapminder.org/dollar-street" width="100%" height="500px" style="border:1px solid;border-radius: 5px;" data-external="1">
</iframe>

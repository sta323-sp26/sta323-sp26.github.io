...
We will be talking more about this package and its features next time.

For now we will be loading it alongside Shiny and using some of its layout features today.

::: {.center}
![](imgs/hex-bslib.png){width="20%"}
:::


::: aside
If you are confused about where a particular function comes from, in general Shiny uses `camelCase` while bslib uses `snake_case`.
:::
...
\begin{aligned}
f(p|y,n,a,b) 
  &= \frac{f(y|n,p) \, \pi(p|a,b)}{\int f(y|n,p) \, \pi(p|a,b) \, dp} \\

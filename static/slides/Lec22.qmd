...
title-slide-attributes:
  data-background-image: "imgs/hex_tidymodels.png"
  data-background-size: "33% auto"
...
![](imgs/ml_illustration.jpg){fig-align="center" width="75%"}


::: {.aside}
Illustration from <https://vas3k.com/blog/machine_learning/>
:::

## Parsnip models

::: {.large .center}
[tidymodels.org/find/parsnip/](https://www.tidymodels.org/find/parsnip/)
:::


<iframe data-src="https://www.tidymodels.org/find/parsnip/" width="100%" height="500px" style="border:1px solid;border-radius: 5px;" data-external="1">
</iframe>



## Other linear regression engines
...
## Fitting with `rstanarm` {.scrollable}
...
## Really putting it all together {.scrollable}

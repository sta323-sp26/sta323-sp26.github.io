---
title: bslib, dynamic UIs,<br/>and publishing
subtitle: "Lecture 19"
...
knitr::knit_engines$set(bslib = function(options) {
  ...
  html = whisker::whisker.render(readr::read_file("Lec19_quarto_bslib.tmpl"))
...
::: aside
For either approach be careful about naming of list elements - these become argument names which may or may not do what you expect, particularly if the function uses `...`.
:::
...
::: {.columns}
::: {.column}
![](imgs/bootstrap-colors.png){width=100% fig-align=center}
:::
::: {.column .xsmall}
...
## Demo - [shinyapps.io](https://shinyapps.io)

...
Lets imagine we have a *10 GB* flat data file and that we want to select certain rows based on a particular criterion. This requires a sequential read across the entire data set.

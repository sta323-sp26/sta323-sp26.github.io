...
The format of duckdb's output (in the CLI) is controled via `.mode` -  the default is `duckbox`, see possible [output formats](https://duckdb.org/docs/api/cli/output_formats.html). 
